...
public class DataEncryptionUtil {
    ...
    public void writeSecretDataWithEncryptedSharedPreferences(String sharedPreferencesFileName, String key, String value)
    ...
    public void deleteAll(String encryptedSharedPreferencesFileName) {
        SharedPreferences sharedPref = application.getSharedPreferences(encryptedSharedPreferencesFileName, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPref.edit();
        editor.clear();
        editor.apply();

        new File(application.getFilesDir(), encryptedSharedPreferencesFileName).delete();
    }
}
